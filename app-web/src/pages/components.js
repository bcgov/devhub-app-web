...
// import { REACT_SCROLL, RESOURCE_TYPES } from '../constants/ui';
...
//       const componentNodes = this.props.data.allDevhubSiphon.edges.map(c => c.node);
...
//       .filter(result => result.resourceType === RESOURCE_TYPES.COMPONENTS)
//       .reduce((obj, result) => {
...
// export const componentResourceQuery = graphql`
//   query componentResourceQuery {
//     allDevhubSiphon(filter: { resource: { type: { eq: "Components" } } }) {
//       edges {
//         node {
//           id
//           name
