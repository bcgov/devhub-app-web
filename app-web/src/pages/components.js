...
export const resourceQueryComponents = graphql`
  query resourceQueryComponents {
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    filterCollectionsByResourceType: () =>
      dispatch(actions.filterSiphonNodes(SIPHON_RESOURCE_TYPE_PROP, RESOURCE_TYPES.COMPONENTS)),
