...
export const resourceQueryRepositories = graphql`
  query resourceQueryRepositories {
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    filterCollectionsByResourceType: () =>
      dispatch(actions.filterSiphonNodes(SIPHON_RESOURCE_TYPE_PROP, RESOURCE_TYPES.REPOSITORIES)),
