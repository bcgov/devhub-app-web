...
export const TopicForm = () => {
    ...
    const LoadSubForm = (index) => {
        if (inputFields[index].sourceType === "github") {
            return (
                <Fragment>
                    <MyTextInput name="url" label="Enter github repository url" onChange={e => handleChange(e,index)}></MyTextInput>
            ...
            return (
                <Fragment>
                    <MyTextInput name="url" label="Enter source url" onChange={e => handleChange(e,index)} ></MyTextInput>
        ...
        <form onSubmit={e => handleSubmit(e)}>
            ...
            {inputFields.map((inputField, index) => (
                <Fragment key={`${inputField}~${index}`}>
                    ...
                    <MySelect name="resourceType" label="What type of content would you like to contribute ?" onChange={e => handleChange(e,index)}>
