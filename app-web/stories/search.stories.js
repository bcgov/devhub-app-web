...
storiesOf('Search Branding', module)
  .add('Algolia brand', () => <AlgoliaLogo title="Search" contents={contents} />)
  .add('Branding with border', () => (
    <AlgoliaLogo title="Search" contents={contents} style={{ border: '5px solid red' }} />
  ))
  .add('Flex box Container', () => (
    <div style={{ display: 'flex' }}>
      <AlgoliaLogo title="Search" contents={contents} />
    </div>
  ));
